...
void man(char *name)
{
    ...
    {
        printf("Descrption : Used to display information of file\n");
...
void DisplayHelp()
{
    ...
    printf("cloaseall : To close all opende files\n");
    ...
    while(1)
    {
        ...
        count = sscanf(str,"%s %s %s %s",command[0],command[1],command[2],command[3]);
            ...
            if(count == 1)
            {
                ...
                {
                    CloseAllFile();
                    printf("All fikes closed successfully\n");
                    continue;
                }
            ...
            else if(count == 3) // Jr command madhe 3 words astil tr
            {
                ...
                else if(strcmp(command[0],"read") == 0)
                {
                    ...
                    if(ptr == NULL)
                    {
                        printf("Error : Memory allocation failture\n");
                        continue;
                    }
